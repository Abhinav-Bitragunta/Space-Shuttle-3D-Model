...
// Iteration: 4 (redesigned)
// Description: Flight deck interior — fully enclosed room with proper
//              corner-overlapping walls, trim strips, two pilot seats
//              with armrests, control yokes, centre console, forward
//              instrument panel (4×6 gauges), overhead switch panel,
//              side consoles, and windshield frames.
...
// ═══════════════════════════════════════════════════════════
// Room enclosure — walls overlap at corners to prevent seams
// ═══════════════════════════════════════════════════════════
static void drawRoomEnclosure() {
    ...
    // NOTE: No ceiling slab here — the payload bay doors (which extend
    // over the cabin) serve as the ceiling. When doors open, you see space.
    ...
    // ── Trim strips along wall-floor and wall-ceiling joints ──
    matIntFrame();
    float trimH = 0.008f;
    float trimD = 0.008f;
...
// ═══════════════════════════════════════════════════════════
// Control yoke — T-shaped stick in front of seat
// ═══════════════════════════════════════════════════════════
