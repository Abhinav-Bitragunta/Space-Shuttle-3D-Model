...
// Iteration: 1 (Iter 2: stack + highlight, Iter 3: lighting, Iter 4: interior/doors)
...
static void drawHighlightOverlay() {
    ...
    // Force every fragment to yellow via a 1×1 texture in REPLACE mode.
    // This overrides whatever glColor3fv the material functions set.
